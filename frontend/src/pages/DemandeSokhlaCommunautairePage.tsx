...
export const DemandeSokhlaCommunautairePage: React.FC = () => {
  ...
  const handleSubmit = async () => {
    if (!formData.montant || !formData.canalReception || !formData.region || !formData.departement || !formData.commune) {
      setShowError(true);
      return;
    }
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">DEMANDE SOKHLA COMMUNAUTAIRE</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
          ...
          <div className="flex items-start gap-4 mb-8">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-1">SOKHLA COMMUNAUTAIRE</h2>
